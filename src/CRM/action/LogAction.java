	...
	public String loadByPage() throws ParseException, IOException{
		...
		if(queryCriteria != null){
			...
			if(!queryCriteria.getKeywords().equals("")){
				criteria.add(Restrictions.or(Restrictions.like("user",queryCriteria.getKeywords(), MatchMode.ANYWHERE)
											,Restrictions.like("method",queryCriteria.getKeywords(),MatchMode.ANYWHERE)));
			}
		...
		EasyUIDatagrid datagrid = logService.loadByPage(criteria,rows,page);
